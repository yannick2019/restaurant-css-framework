let PolicyText = "",
closeBtnImage = '<img src="/images/close.png" />';
...
const checkPlicyCookie = () => {
    ...
    if (vp_cookie_val !== "msgboxhide") {
        ...
        PolicyElement.innerHTML+= '<div id="CookieMsgBox" style="position: fixed; bottom: 0px; width: 100%; display: block; z-index: 999999; left: 0px;"><div class="MsgBoxContainer" style="width:100%; height:auto; background-color:#fff; min-height: 46px; border:1px solid #f3f3f3; display:inline-block; position:relative; margin: auto; box-sizing: border-box;"><div class="MsgBoxContent" style="font-size: 20px; line-height:18px; text-align:left; color:#000; padding:10px 40px 5px 10px; max-width: 940px; margin: auto; position: relative;"><span style="font-size:13px !important; line-height:15px; font-weight:normal !important;">'+PolicyText+'</span><div class="closeBtn" onclick="setPlicyCookie();" style="position:absolute; right: 17px; top:32%; cursor:pointer;">'+closeBtnImage+'</div></div></div>';
